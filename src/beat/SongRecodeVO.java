...
public class SongRecodeVO {
	...
	public SongRecodeVO(String titleName, String difficulty, int score, int acPerfect, int acGreat, int acNomal,
	...
	public int getacNomal() {
		return acNomal;
	}

	public void setacNomal(int acNomal) {
		this.acNomal = acNomal;
	}
	...
	public String toString() {
		return "SongRecodeVO [titleName=" + titleName + ", difficulty=" + difficulty + ", score=" + score
				+ ", acPerfect=" + acPerfect + ", acGreat=" + acGreat + ", acNomal=" + acNomal + ", acBad=" + acBad
